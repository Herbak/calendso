...
export default function Embed(props: inferSSRProps<typeof getServerSideProps>) {
  ...
  return (
    <Shell
      heading="Intégration &amp; Webhooks"
      subtitle="Intégrez Avocal dans votre site en utilisant nos options d'intégration, ou récupérez les informations de prise de rendez-vous en temps réel en utilisant des webhooks.">
      <SettingsShell>
        {!editWebhookEnabled && (
            ...
            <div className="flex justify-between my-6">
              ...
              <div>
                <Dialog>
                  ...
                  <DialogContent>
                    <DialogHeader
                      title="Creer un nouveau webhook"
                      subtitle="Créer un nouveau webhook pour votre compte"
                    />
                    <div className="my-4">
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          name="subUrl"
                          id="subUrl"
                          placeholder="https://example.com/cible"
                          required
                        ...
                        <div className="p-2 border border-gray-300 rounded-sm">
                          <div className="flex pb-4">
                            <div className="w-10/12">
                              <h2 className="font-medium text-gray-800">Rendez-vous créé</h2>
                            </div>
                          ...
                          <div className="flex py-1">
                            <div className="w-10/12">
                              <h2 className="font-medium text-gray-800">Rendez-vous replanifié</h2>
                            </div>
                            <div className="flex items-center justify-center w-2/12 text-right">
                              <Switch
                                defaultChecked={true}
                          ...
                          <div className="flex pt-4">
                            <div className="w-10/12">
                              <h2 className="font-medium text-gray-800">Rendez-vous annulé</h2>
                            </div>
                            <div className="flex items-center justify-center w-2/12 text-right">
                              <Switch
                                defaultChecked={true}
